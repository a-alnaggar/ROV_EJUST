...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /opt/ros-node/catkin_ws/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /opt/ros-node/catkin_ws/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /opt/ros-node/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros-node/catkin_ws/src/beginner_tutorials/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/ros-node/catkin_ws/devel/lib;/opt/ros/noetic/lib)
